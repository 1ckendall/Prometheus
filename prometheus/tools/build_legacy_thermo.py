...
from prometheus.equilibrium.species import AFCESICCoeff, SpeciesDatabase
from prometheus.thermo_data.parsers.afcesic import collect_afcesic_species, dump_afcesic_raw
from prometheus.thermo_data.parsers.terra import TERRAParser
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    terra = sub.add_parser("terra", help="Build terra.json from terra.bas + terra_a.bas")
    ...
    afc_cal.add_argument("--terra-bas", default=str(_RAW_DIR / "terra.bas"), dest="terra_bas")
    afc_cal.add_argument("--terra-a-bas", default=str(_RAW_DIR / "terra_a.bas"), dest="terra_a_bas")
