...
from prometheus.gui.engine import EngineDock
from prometheus.gui.pages.analysis import AnalysisPage
from prometheus.gui.pages.library import LibraryPage
from prometheus.gui.pages.simulator import SimulatorPage
...
class ProPepUI(QMainWindow):
    ...
    def on_solver_changed(self, action):
        from prometheus.equilibrium.solver import GordonMcBrideSolver, MajorSpeciesSolver
