...
from PySide6.QtWidgets import (QGridLayout, QTabWidget, QTextEdit, QVBoxLayout,
                               QWidget)

from prometheus.gui.widgets.graph_canvas import GraphCanvas
...
class AnalysisPage(QWidget):
    ...
    def update_expansion_plots(self, result):
        ...
        def _plot_two(canvas, x1, y1, label1, x2=None, y2=None, label2=None):
            ...
            canvas.axes.semilogx(x1, y1, "o-", markersize=4, color="#2a82da", label=label1)
            if x2 is not None and y2 is not None:
                canvas.axes.semilogx(x2, y2, "s--", markersize=4, color="#f39c12", label=label2)
    ...
    def update_performance_plots(self, cases, sweep_axis="none", sweep_label="Run Index"):
        ...
        _plot(self.canvas_expansion, area_shift, area_frozen, label1="Ae/At Shift", label2="Ae/At Frozen")
