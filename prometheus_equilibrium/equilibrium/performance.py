...
from prometheus.equilibrium.solution import EquilibriumSolution
from prometheus.equilibrium.solver import EquilibriumSolver, GordonMcBrideSolver
...
class PerformanceSolver:
    ...
    def _solve_at_p(
        ...
        if shifting:
            from prometheus.equilibrium.problem import EquilibriumProblem as EP
