...
.. list-table::
   ...
   * - :class:`~prometheus.equilibrium.solver.GordonMcBrideSolver`
     ...
     - Complete
   * - :class:`~prometheus.equilibrium.solver.HybridSolver`
     - Alternative solver
     - Complete
   * - :class:`~prometheus.equilibrium.solver.PEPSolver`
     - Not implemented (strictly inferior to Hybrid)
     - Deferred indefinitely

:class:`~prometheus.equilibrium.solver.GordonMcBrideSolver` is the recommended
...
:class:`~prometheus.equilibrium.solver.HybridSolver` remains available as an
